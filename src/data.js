...
export const LANGUAGES = [
  { description: 'English', rating: 5 },
  { description: 'Portuguese', rating: 5 },
  { description: 'German', rating: 1 }
];

export const EXPERIENCES = [
  { company: 'Pixel Fusion', period: 'May 2017 - Now', position: 'Front End Developer', location: 'Auckland, New Zealand', description: 'I am working together with designers and developers to build great digital products. As a developer, I am helping the team with the development of new products using React, NodeJS, Atomic Design, SASS and TDD.' },
